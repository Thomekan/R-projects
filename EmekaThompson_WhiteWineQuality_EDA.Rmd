Project Title: Exloratory Data Analysis of White wine Quality
Author: Emeka Thompson

========================================================
Data Source: This dataset is available for public research and education purposes.
P. Cortez, A. Cerdeira, F. Almeida, T. Matos and J. Reis. 
Modeling wine preferences by data mining from physicochemical properties. 
In Decision Support Systems, Elsevier, 47(4):547-553. ISSN: 0167-9236.

R code source: This project was inspired by Alina Bolat's github and is not originally by me.
========================================================
...
# Libraries
library(pacman)
  #library(ggplot2)  #contained in pacman
  #library(dplyr)    #contained in pacman
library(gridExtra)
library(psych)
library(corrplot)
...
# Load the Data
wq <- read.csv('C:/Users/dtosi/Downloads/winequality-white.csv', sep=";", header=T)
#wq <- import("C:/Users/dtosi/Downloads/winequality-white.csv")  #this allows me to do the same as read.csv using rio
head(wq)
...
The residual sugar and density have the highest positive correlation in the data set.
...
This clean data set has enabled by to explore and learn about wine phisico-chemical properties, as well as find some unexpected relationships.  
...
It is important to note that findings in this analysis are strictly subjective to the data set provided, correlation does not imply causation. And the relationships found in this analysis may be influenced by other factors.

The quality rating given by a somelier is based on more than the physico-chemical properties of the wine. For instance, period and conditions of wine aging, grape type and tasting conditions are all very important aspects of an accurate quality rating of wines. None of these aspects were given in an initial data set due to confidentiality. A fuller data set with more variables would have enabled to investigate if wines with different origins have different chemical properties. Or perhaps if wine preparation process affects it's final quality.

Furthermore, A bigger sample would have enabled to have more category counts, and perhaps it would have improved some bias in this analysis.
